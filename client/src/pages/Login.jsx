...
const Login = () => {
  ...
  return (
    ...
    >
      <div
        className="absolute top-[-8%] left-[20%] w-150 h-125 rounded-full pointer-events-none"
        style={{
          background:
      ...
      />
      <div
        className="absolute bottom-0 right-[10%] w-100 h-87.5 rounded-full pointer-events-none"
        style={{
          background:
      ...
      >
        ...
        <div
          ...
          style={{
            background: "linear-gradient(160deg, #0a0d18, #0c0e15)",
        ...
        >
          <div
            ...
            style={{
              padding: "1px",
              background:
                "linear-gradient(135deg, rgba(37,99,235,0.4), rgba(59,130,246,0.1))",
              WebkitMask:
          ...
          <div className="relative z-10">
            ...
            <p
              ...
              style={{ color: "#475569" }}
            >
              Sign in to your ATSify account
            </p>
